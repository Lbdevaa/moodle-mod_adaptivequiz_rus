...
$string['startinglevel_help'] = 'Когда учащийся начинает попытку, в процессе задания случайным образом выбирается вопрос, соответствующий уровню сложности.';
$string['lowestlevel'] = 'Минимальный уровень сложности';
$string['lowestlevel_help'] = 'Самый низкий или наименее сложный уровень, из которого будут выбраны вопросы. Во время попытки теста не будет выходить за рамки этого уровня сложности.';
$string['highestlevel'] = 'Максимальный уровнь сложности';
$string['highestlevel_help'] = 'Самый высокий или самый сложный уровень, из которого будут выбраны вопросы. Во время попытки теста не будет выходить за рамки этого уровня сложности.';
...
$string['standarderror_help'] = 'Когда количество ошибок в оценке способностей пользователя упадет ниже этого значения, тестирование остановится. Измените это значение с 5% (по умолчанию), чтобы получать большее или меньшее точную оценку при измерении знаний.';
$string['formelementdecimal'] = 'Введите десятичное число. Максимум 10 цифр и максимум 5 цифр справа от десятичной точки.';
$string['attemptfeedback'] = 'Результат теста';
$string['attemptfeedback_help'] = 'Результат о попытке теста отображается пользователю после ее завершения.';
...
$string['attemptquestion_ability'] = 'Возможность измерения';
